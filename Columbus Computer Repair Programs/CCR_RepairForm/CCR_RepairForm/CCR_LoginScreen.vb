...
Public Class CCR_LoginScreen
    ...
    Const TECHNICIANUSERNAME_STRING As String = "technician"
    ...
    Private Sub LoginButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LoginButton.Click
        ...
        If UsernameTextBox.Text = MANAGERUSERNAME_STRING And PasswordTextBox.Text = MANAGERUSERNAME_STRING Or
            UsernameTextBox.Text = TECHNICIANUSERNAME_STRING And PasswordTextBox.Text = TECHNICIANUSERNAME_STRING Then
            RepairForm.Show()
            Me.Visible = False
