...
Partial Public Class ColumbusComputerRepair_DatabaseDataSet
    ...
    Partial Public Class CustomerDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddCustomerRow(ByVal Customer_ID As Integer, ByVal Customer_Name As String, ByVal Customer_Address As String, ByVal Customer_Phone As String, ByVal Customer_Type As String, ByVal Email_Address As String) As CustomerRow
            Dim rowCustomerRow As CustomerRow = CType(Me.NewRow,CustomerRow)
            Dim columnValuesArray() As Object = New Object() {Customer_ID, Customer_Name, Customer_Address, Customer_Phone, Customer_Type, Email_Address}
    ...
    Partial Public Class CustomerTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Customer` WHERE ((`Customer_ID` = ?) AND ((? = 1 AND `Customer_Name`"& _ 
                " IS NULL) OR (`Customer_Name` = ?)) AND ((? = 1 AND `Customer_Address` IS NULL) "& _ 
                "OR (`Customer_Address` = ?)) AND ((? = 1 AND `Customer_Phone` IS NULL) OR (`Cust"& _ 
                "omer_Phone` = ?)) AND ((? = 1 AND `Customer_Type` IS NULL) OR (`Customer_Type` ="& _ 
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_Customer_Address", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Customer_Address", Global.System.Data.DataRowVersion.Original, true, Nothing))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_Customer_Address", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Customer_Address", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_Customer_Type", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Customer_Type", Global.System.Data.DataRowVersion.Original, true, Nothing))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_Customer_Type", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Customer_Type", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Customer` (`Customer_ID`, `Customer_Name`, `Customer_Address`, `Cust"& _ 
                "omer_Phone`, `Customer_Type`, `Email_Address`) VALUES (?, ?, ?, ?, ?, ?)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Customer_Address", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Customer_Address", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Customer_Type", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Customer_Type", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Customer` SET `Customer_ID` = ?, `Customer_Name` = ?, `Customer_Address` "& _ 
                "= ?, `Customer_Phone` = ?, `Customer_Type` = ?, `Email_Address` = ? WHERE ((`Cus"& _ 
                "tomer_ID` = ?) AND ((? = 1 AND `Customer_Name` IS NULL) OR (`Customer_Name` = ?)"& _ 
                ") AND ((? = 1 AND `Customer_Address` IS NULL) OR (`Customer_Address` = ?)) AND ("& _ 
                "(? = 1 AND `Customer_Phone` IS NULL) OR (`Customer_Phone` = ?)) AND ((? = 1 AND "& _ 
                "`Customer_Type` IS NULL) OR (`Customer_Type` = ?)) AND ((? = 1 AND `Email_Addres"& _ 
                "s` IS NULL) OR (`Email_Address` = ?)))"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Customer_Address", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Customer_Address", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Customer_Type", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Customer_Type", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_Customer_Address", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Customer_Address", Global.System.Data.DataRowVersion.Original, true, Nothing))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_Customer_Address", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Customer_Address", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_Customer_Type", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Customer_Type", Global.System.Data.DataRowVersion.Original, true, Nothing))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_Customer_Type", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Customer_Type", Global.System.Data.DataRowVersion.Original, false, Nothing))
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.CCR_CustomerForm.My.MySettings.Default.ColumbusComputerRepair_DatabaseConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Customer_ID, Customer_Name, Customer_Address, Customer_Phone, Customer_Typ"& _ 
                "e, Email_Address FROM Customer"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As ColumbusComputerRepair_DatabaseDataSet.CustomerDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As ColumbusComputerRepair_DatabaseDataSet.CustomerDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As ColumbusComputerRepair_DatabaseDataSet.CustomerDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Customer_ID As Integer, ByVal Original_Customer_Name As String, ByVal Original_Customer_Address As String, ByVal Original_Customer_Phone As String, ByVal Original_Customer_Type As String, ByVal Original_Email_Address As String) As Integer
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(8).Value = CType(Original_Customer_Type,String)
            End If
        ...
        Public Overloads Overridable Function Insert(ByVal Customer_ID As Integer, ByVal Customer_Name As String, ByVal Customer_Address As String, ByVal Customer_Phone As String, ByVal Customer_Type As String, ByVal Email_Address As String) As Integer
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(4).Value = CType(Customer_Type,String)
            End If
        ...
        Public Overloads Overridable Function Update(ByVal Customer_ID As Integer, ByVal Customer_Name As String, ByVal Customer_Address As String, ByVal Customer_Phone As String, ByVal Customer_Type As String, ByVal Email_Address As String, ByVal Original_Customer_ID As Integer, ByVal Original_Customer_Name As String, ByVal Original_Customer_Address As String, ByVal Original_Customer_Phone As String, ByVal Original_Customer_Type As String, ByVal Original_Email_Address As String) As Integer
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(Customer_Type,String)
            End If
            If (Email_Address Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(14).Value = CType(Original_Customer_Type,String)
            End If
            If (Original_Email_Address Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(16).Value = CType(Original_Email_Address,String)
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Customer_Name As String, ByVal Customer_Address As String, ByVal Customer_Phone As String, ByVal Customer_Type As String, ByVal Email_Address As String, ByVal Original_Customer_ID As Integer, ByVal Original_Customer_Name As String, ByVal Original_Customer_Address As String, ByVal Original_Customer_Phone As String, ByVal Original_Customer_Type As String, ByVal Original_Email_Address As String) As Integer
            Return Me.Update(Original_Customer_ID, Customer_Name, Customer_Address, Customer_Phone, Customer_Type, Email_Address, Original_Customer_ID, Original_Customer_Name, Original_Customer_Address, Original_Customer_Phone, Original_Customer_Type, Original_Email_Address)
        End Function
    End Class
